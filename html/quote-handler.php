<?php
  ...
  $list = $_POST["list"];
	...
	$subject="Quote requested by {$name}";
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' width: 150px; height: auto; margin-top: 15px; ' src='http://www.customstoneworkpk.com/images/csw-logo-black.png' ></td>
	</tr>
	<tr>
  ...
  <tr>
	...
	<td align='left' valign='top' style='border-top:1px solid #dfdfdf; border-bottom:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 0 7px 5px;'>".nl2br($list)."</td>
	</tr>
	</table>
	</body>
	</html>
